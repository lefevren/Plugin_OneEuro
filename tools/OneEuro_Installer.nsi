...
Name "OneEuro Plugin ${VERSION} for CryEngine"

; The file to write
OutFile "Plugin_OneEuro_${VERSION}.exe"
...
; Sections
Section "OneEuro" SEC_PLUGIN
    SectionIn RO
        
    SetOutPath "$INSTDIR\Bin32\Plugins\OneEuro"
    ;File "${FILES_ROOT}\..\..\Bin32\Plugins\OneEuro\Plugin_OneEuro.dll"
	File "${FILES_ROOT}\..\..\Bin32\Plugins\OneEuro\*.dll"

    SetOutPath "$INSTDIR\Bin64\Plugins\OneEuro"
    ;File "${FILES_ROOT}\..\..\Bin64\Plugins\OneEuro\Plugin_OneEuro.dll"
    File "${FILES_ROOT}\..\..\Bin64\Plugins\OneEuro\*.dll"

	; Standard Code directory also used in git repo
    SetOutPath "$INSTDIR\Code\Plugin_OneEuro"
...
Section "Interface Headers" SEC_INTERFACE
    SetOutPath "$INSTDIR\Code\Plugin_OneEuro\inc"
...
; Set Fileinfos
VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductName" "OneEuro Plugin"
VIAddVersionKey /LANG=${LANG_ENGLISH} "LegalCopyright" "Copyright (c) 2013, The authors of the OneEuro Plugin project"
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileDescription" "OneEuro Plugin for CryEngine"
...
Function "ShowChangelog"
	Exec 'notepad "$INSTDIR\Code\Plugin_OneEuro\changelog.md"'
FunctionEnd
