...
class CFlowOneEuroFilterQuat : public CFlowBaseNode<eNCT_Instanced>
{
    ...
    public:
        ...
        virtual void GetConfiguration( SFlowNodeConfig& config )
        {
            ...
            config.sDescription = _HELP( "CryVR node that filter a Quaternion with OneEuro filter" );
...
REGISTER_FLOW_NODE( "CryVR:Filters_Plugin:OneEuroFilterQuaternion", CFlowOneEuroFilterQuat );
